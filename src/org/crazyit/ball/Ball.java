...
public class Ball extends BallComponent {
     ...
     * m 有参数构造器
     *
     * @param panelWidth  int 画板宽度
     * @param panelHeight int 画板高度
     * @param offset      int 位移
    ...
    public Ball(int panelWidth, int panelHeight, int offset, String path)
        ...
        // 设置y坐标
        this.setY(panelHeight - super.getImgHeight() - offset);
        //HEI
        this.setImgHeight(super.getImgHeight());
        this.setImgWidth(super.getImgWidth());
    }
